...
function FinishStudy() {
  return <section className="finish-study" aria-label="Premium finish study">
    <div className="finish-study-media"><Image src="/media-v27/images/porsche-rear.webp" alt="Glossy performance vehicle finish" fill sizes="100vw" /></div>
    <div className="finish-study-shade" />
    <div className="finish-study-copy"><span>IMMERSIVE FINISH STUDY</span><h2>Depth without the drag.</h2><p>A cinematic, lightweight showcase that keeps the premium motion and visual impact without loading a live 3D scene.</p></div>
  </section>;
}
