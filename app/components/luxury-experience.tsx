...
export function LuxuryExperience() {
  ...
  return <main className="v4-home">
    ...
    <section className="v4-cinema v4-cinema-portrait" aria-label="Cinematic automotive presentation">
      ...
      <div className="v4-cinema-media">
        <CinematicVideo src="/media/cinematic/white-coupe-coast.mp4" poster="/media/cinematic/white-coupe-coast-poster.webp" label="White sports coupe beside the coast" />
        <div className="v4-cinema-frame" aria-hidden="true"><span>01</span><i /></div>
      </div>
