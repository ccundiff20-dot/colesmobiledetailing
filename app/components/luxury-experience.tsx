  ...
  return <main className="v4-home">
    ...
    <section className="v4-gallery-preview">
      ...
      <div className="v4-gallery-grid">
        ...
        <figure className="video-tile"><CinematicVideo src="/media/cinematic/scenic-sports-car.mp4" poster="/media/cinematic/scenic-sports-car-poster.webp" label="White sports car on a scenic lakeside drive" /><figcaption><span>03</span>Cinematic finish study <small>Erik Mclean / Pexels</small></figcaption></figure>
      </div>
